...
// Defination For Microsoft Active Directory B2C
hello.aadb2c = {};
hello.aadb2c.init = function(tenantName, applicationId, signInSignUpPolicyName, post_login_redirect_uri, post_logout_redirect_uri) {

	hello.aadb2c.policyName = signInSignUpPolicyName;
	
	var aadb2cPolicyDefination = {};
	aadb2cPolicyDefination[signInSignUpPolicyName] = {
			name: 'Azure Active Directory B2C',
			oauth: {
				version: 2,
				auth: ("https://login.microsoftonline.com/tfp/" 
						+ tenantName + "/" 
						+ signInSignUpPolicyName 
						+ "/oauth2/v2.0/authorize"),
				grant: ("https://login.microsoftonline.com/tfp/" 
						+ tenantName + "/" 
						+ signInSignUpPolicyName 
						+ "/oauth2/v2.0/token")
			},
			...
			logout: function () {
				...
				var id_token = hello("adB2CSignInSignUp").getAuthResponse().id_token;
				//clearing local storage session
				hello.utils.store("adB2CSignInSignUp", null);
				//redirecting to Azure B2C logout URI
				window.location.href = ("https://login.microsoftonline.com/" + tenantName 
										+ "/oauth2/v2.0/logout?p=" + signInSignUpPolicyName 
	...
	hello.init(aadb2cPolicyDefination);

	var policyNameToAppIdObj = {};
	policyNameToAppIdObj[signInSignUpPolicyName] = applicationId;
	hello.init(
		policyNameToAppIdObj, 
		{
